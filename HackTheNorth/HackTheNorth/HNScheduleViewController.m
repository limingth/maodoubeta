...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.name = @"新概念C语言"; // [infoDict objectForKey:@"name"];
        cell.location = @"北京"; // [infoDict objectForKey:@"location"];
        cell.startTime = [infoDict objectForKey:@"start_time"];
        cell.speaker = @"李明"; // [infoDict objectForKey:@"speaker"];
        cell.descriptor = @"在实践中学习 Rails 开发"; // [infoDict objectForKey:@"description"];
        cell.type = @"Rails"; // [infoDict objectForKey:@"type"];
